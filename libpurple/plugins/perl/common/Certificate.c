...
;
	...
	{
	    SV * RETVALSV;
	    RETVALSV = purple_perl_bless_object(RETVAL, "Purple::Certificate");
...
;
	...
	{
	    SV * RETVALSV;
	    RETVALSV = purple_perl_bless_object(RETVAL, "Purple::Certificate::Pool");
	    RETVALSV = sv_2mortal(RETVALSV);
	    ST(0) = RETVALSV;
	}
    }
...
;
	...
	{
	    SV * RETVALSV;
	    RETVALSV = purple_perl_bless_object(RETVAL, "Purple::Certificate::Scheme");
	    RETVALSV = sv_2mortal(RETVALSV);
	    ST(0) = RETVALSV;
	}
    }
...
;
	...
	{
	    SV * RETVALSV;
	    RETVALSV = purple_perl_bless_object(RETVAL, "Purple::Certificate::Verifier");
	    RETVALSV = sv_2mortal(RETVALSV);
	    ST(0) = RETVALSV;
	}
    }
...
XS_EUPXS(XS_Purple__Certificate_get_fingerprint_sha256); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_Purple__Certificate_get_fingerprint_sha256)
{
    dVAR; dXSARGS;
    if (items != 2)
       croak_xs_usage(cv,  "crt, sha1_fallback");
    {
	Purple__Certificate	crt = purple_perl_ref_object(ST(0))
;
	gboolean	sha1_fallback = (bool)SvTRUE(ST(1))
;
#line 227 "Certificate.xs"
		GByteArray *gba = NULL;
#line 837 "Certificate.c"
	SV *	RETVAL;
#line 229 "Certificate.xs"
		gba = purple_certificate_get_fingerprint_sha256(crt, sha1_fallback);
		RETVAL = newSVpv((gchar *)gba->data, gba->len);
		g_byte_array_free(gba, TRUE);
#line 843 "Certificate.c"
	RETVAL = sv_2mortal(RETVAL);
	ST(0) = RETVAL;
    }
    XSRETURN(1);
...
;
	...
	SV *	cb_data = ST(4)
;
#line 242 "Certificate.xs"
		GList *l = NULL;
		int len = 0, i = 0;
		struct cb_data *d = NULL;
#line 871 "Certificate.c"
...
XS_EUPXS(XS_Purple__Certificate__Pool_get_idlist)
{
	...
	Purple__Certificate__Pool	pool = purple_perl_ref_object(ST(0))
;
#line 273 "Certificate.xs"
		GList *l, *b;
#line 926 "Certificate.c"
#line 275 "Certificate.xs"
		b = purple_certificate_pool_get_idlist(pool);
		for(l = b; l; l = l->next) {
			XPUSHs(sv_2mortal(newSVpv(l->data, 0)));
		}
		purple_certificate_pool_destroy_idlist(b);
#line 933 "Certificate.c"
	PUTBACK;
	return;
    }
}
...
#  endif
        ...
        (void)newXSproto_portable("Purple::Certificate::get_fingerprint_sha256", XS_Purple__Certificate_get_fingerprint_sha256, file, "$$");
