...
XS_EUPXS(XS_Purple__Core_quit_cb); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_Purple__Core_quit_cb)
{
    dVAR; dXSARGS;
    if (items != 0)
       croak_xs_usage(cv,  "");
...
XS_EUPXS(XS_Purple__Core_get_version); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_Purple__Core_get_version)
{
    dVAR; dXSARGS;
    if (items != 0)
       croak_xs_usage(cv,  "");
...
XS_EUPXS(XS_Purple__Core_get_ui); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_Purple__Core_get_ui)
{
    dVAR; dXSARGS;
    if (items != 0)
       croak_xs_usage(cv,  "");
...
extern "C"
#endif
XS_EXTERNAL(boot_Purple__Core); /* prototype to pass -Wmissing-prototypes */
XS_EXTERNAL(boot_Purple__Core)
{
#if PERL_VERSION_LE(5, 21, 5)
    dVAR; dXSARGS;
#else
