...
XS_EUPXS(XS_Purple__Privacy_permit_add); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_Purple__Privacy_permit_add)
{
    dVAR; dXSARGS;
    if (items != 3)
...
XS_EUPXS(XS_Purple__Privacy_permit_remove); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_Purple__Privacy_permit_remove)
{
    dVAR; dXSARGS;
    if (items != 3)
       croak_xs_usage(cv,  "account, name, local_only");
...
XS_EUPXS(XS_Purple__Privacy_deny_add); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_Purple__Privacy_deny_add)
{
    dVAR; dXSARGS;
    if (items != 3)
       croak_xs_usage(cv,  "account, name, local_only");
...
XS_EUPXS(XS_Purple__Privacy_deny_remove); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_Purple__Privacy_deny_remove)
{
    dVAR; dXSARGS;
    if (items != 3)
       croak_xs_usage(cv,  "account, name, local_only");
...
XS_EUPXS(XS_Purple__Privacy_check); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_Purple__Privacy_check)
{
    dVAR; dXSARGS;
    if (items != 2)
...
extern "C"
#endif
XS_EXTERNAL(boot_Purple__Privacy); /* prototype to pass -Wmissing-prototypes */
XS_EXTERNAL(boot_Purple__Privacy)
{
#if PERL_VERSION_LE(5, 21, 5)
    dVAR; dXSARGS;
#else
