...
XS_EUPXS(XS_Purple__Sound_play_event); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_Purple__Sound_play_event)
{
    dVAR; dXSARGS;
    if (items != 2)
...
XS_EUPXS(XS_Purple__Sound_play_file); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_Purple__Sound_play_file)
{
    dVAR; dXSARGS;
    if (items != 2)
...
extern "C"
#endif
XS_EXTERNAL(boot_Purple__Sound); /* prototype to pass -Wmissing-prototypes */
XS_EXTERNAL(boot_Purple__Sound)
{
#if PERL_VERSION_LE(5, 21, 5)
    dVAR; dXSARGS;
#else
