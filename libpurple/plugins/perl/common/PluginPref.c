...
XS_EUPXS(XS_Purple__PluginPref__Frame_new)
{
	...
	{
	    SV * RETVALSV;
	    RETVALSV = purple_perl_bless_object(RETVAL, "Purple::PluginPref::Frame");
...
XS_EUPXS(XS_Purple__PluginPref_new)
{
	...
	{
	    SV * RETVALSV;
	    RETVALSV = purple_perl_bless_object(RETVAL, "Purple::PluginPref");
	    RETVALSV = sv_2mortal(RETVALSV);
	    ST(0) = RETVALSV;
	}
    }
