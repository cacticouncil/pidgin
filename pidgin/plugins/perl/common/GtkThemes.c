...
#line 157 "GtkThemes.c"

XS_EUPXS(XS_Pidgin__Themes_init); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_Pidgin__Themes_init)
{
    dVAR; dXSARGS;
    if (items != 0)
       croak_xs_usage(cv,  "");
...
XS_EUPXS(XS_Pidgin__Themes_smileys_disabled); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_Pidgin__Themes_smileys_disabled)
{
    dVAR; dXSARGS;
    if (items != 0)
       croak_xs_usage(cv,  "");
...
XS_EUPXS(XS_Pidgin__Themes_smiley_theme_probe); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_Pidgin__Themes_smiley_theme_probe)
{
    dVAR; dXSARGS;
    if (items != 0)
       croak_xs_usage(cv,  "");
...
XS_EUPXS(XS_Pidgin__Themes_load_smiley_theme); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_Pidgin__Themes_load_smiley_theme)
{
    dVAR; dXSARGS;
    if (items != 2)
...
XS_EUPXS(XS_Pidgin__Themes_get_proto_smileys); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_Pidgin__Themes_get_proto_smileys)
{
    dVAR; dXSARGS;
    if (items != 1)
...
extern "C"
#endif
XS_EXTERNAL(boot_Pidgin__Themes); /* prototype to pass -Wmissing-prototypes */
XS_EXTERNAL(boot_Pidgin__Themes)
{
#if PERL_VERSION_LE(5, 21, 5)
    dVAR; dXSARGS;
#else
