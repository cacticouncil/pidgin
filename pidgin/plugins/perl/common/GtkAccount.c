...
#line 157 "GtkAccount.c"

XS_EUPXS(XS_Pidgin__Account_get_handle); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_Pidgin__Account_get_handle)
{
    dVAR; dXSARGS;
    if (items != 0)
       croak_xs_usage(cv,  "");
...
XS_EUPXS(XS_Pidgin__Account__Dialog_show); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_Pidgin__Account__Dialog_show)
{
    dVAR; dXSARGS;
    if (items != 2)
...
XS_EUPXS(XS_Pidgin__Account__Window_show); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_Pidgin__Account__Window_show)
{
    dVAR; dXSARGS;
    if (items != 0)
       croak_xs_usage(cv,  "");
...
XS_EUPXS(XS_Pidgin__Account__Window_hide); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_Pidgin__Account__Window_hide)
{
    dVAR; dXSARGS;
    if (items != 0)
       croak_xs_usage(cv,  "");
...
extern "C"
#endif
XS_EXTERNAL(boot_Pidgin__Account); /* prototype to pass -Wmissing-prototypes */
XS_EXTERNAL(boot_Pidgin__Account)
{
#if PERL_VERSION_LE(5, 21, 5)
    dVAR; dXSARGS;
#else
