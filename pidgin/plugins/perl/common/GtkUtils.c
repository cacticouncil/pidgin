...
XS_EUPXS(XS_Pidgin__Utils_save_accels); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_Pidgin__Utils_save_accels)
{
    dVAR; dXSARGS;
    if (items != 1)
...
XS_EUPXS(XS_Pidgin__Utils_load_accels); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_Pidgin__Utils_load_accels)
{
    dVAR; dXSARGS;
    if (items != 0)
       croak_xs_usage(cv,  "");
...
XS_EUPXS(XS_Pidgin__Utils_convert_buddy_icon); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_Pidgin__Utils_convert_buddy_icon)
{
    dVAR; dXSARGS;
    if (items != 3)
...
extern "C"
#endif
XS_EXTERNAL(boot_Pidgin__Utils); /* prototype to pass -Wmissing-prototypes */
XS_EXTERNAL(boot_Pidgin__Utils)
{
#if PERL_VERSION_LE(5, 21, 5)
    dVAR; dXSARGS;
#else
