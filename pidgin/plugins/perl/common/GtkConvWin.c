...
XS_EUPXS(XS_Pidgin__Conversation__Window_new)
{
	...
	{
	    SV * RETVALSV;
	    RETVALSV = purple_perl_bless_object(RETVAL, "Pidgin::Conversation::Window");
...
;
	...
	{
	    SV * RETVALSV;
	    RETVALSV = purple_perl_bless_object(RETVAL, "Pidgin::Conversation");
	    RETVALSV = sv_2mortal(RETVALSV);
	    ST(0) = RETVALSV;
	}
    }
...
;
	...
	{
	    SV * RETVALSV;
	    RETVALSV = purple_perl_bless_object(RETVAL, "Pidgin::Conversation::PlacementFunc");
	    RETVALSV = sv_2mortal(RETVALSV);
	    ST(0) = RETVALSV;
	}
    }
...
#line 136 "GtkConvWin.xs"
	GList *l;
#line 685 "GtkConvWin.c"
#line 138 "GtkConvWin.xs"
	for (l = pidgin_conv_windows_get_list(); l != NULL; l = l->next) {
		XPUSHs(sv_2mortal(purple_perl_bless_object(l->data, "Pidgin::Conversation::Window")));
	}
#line 690 "GtkConvWin.c"
	PUTBACK;
	return;
    }
}
