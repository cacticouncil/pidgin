  ...
  if (g_once_init_enter (&g_define_type_id__volatile))
    {
      static const GFlagsValue values[] = {
        ...
        { GTK_DEBUG_ICONFALLBACK, "GTK_DEBUG_ICONFALLBACK", "iconfallback" },
        { 0, NULL, NULL }
      };
      GType g_define_type_id =
...
gtk_symbolic_color_get_type (void)
{
  ...
  if (g_once_init_enter (&g_define_type_id__volatile))
    {
      static const GEnumValue values[] = {
        { GTK_SYMBOLIC_COLOR_FOREGROUND, "GTK_SYMBOLIC_COLOR_FOREGROUND", "foreground" },
        { GTK_SYMBOLIC_COLOR_ERROR, "GTK_SYMBOLIC_COLOR_ERROR", "error" },
        { GTK_SYMBOLIC_COLOR_WARNING, "GTK_SYMBOLIC_COLOR_WARNING", "warning" },
        { GTK_SYMBOLIC_COLOR_SUCCESS, "GTK_SYMBOLIC_COLOR_SUCCESS", "success" },
        { 0, NULL, NULL }
      };
      GType g_define_type_id =
        g_enum_register_static (g_intern_static_string ("GtkSymbolicColor"), values);
      g_once_init_leave (&g_define_type_id__volatile, g_define_type_id);
    }
